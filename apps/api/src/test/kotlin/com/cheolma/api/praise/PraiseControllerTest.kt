...
class PraiseControllerTest(
    ...
    @param:Autowired private val actionLogs: com.cheolma.api.admin.AdminActionLogRepository,
    ...
    private fun token(id: Long, name: String) =
        jwt.issue(User(id = id, email = "test-user-$id@cheolma.local", passwordHash = "x", name = name))
