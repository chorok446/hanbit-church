...
class PraiseControllerTest(
    ...
    @param:Autowired private val actionLogs: com.dasida.api.admin.AdminActionLogRepository,
    ...
    private fun token(id: Long, name: String) =
        jwt.issue(User(id = id, email = "test-user-$id@dasida.local", passwordHash = "x", name = name))
