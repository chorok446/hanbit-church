...
class JwtAuthFilter(
        ...
        if (token != null) {
            try {
                ...
                val authorities = buildList {
                    ...
                    if (storedUser.role != com.cheolma.api.auth.UserRole.USER.name &&
                        runCatching { com.cheolma.api.auth.UserRole.valueOf(storedUser.role) }.isSuccess
                    ) {
    ...
    private companion object {
        ...
        const val STORE_UNAVAILABLE_METRIC = "cheolma.security.token_denylist.store_unavailable"
    }
}
