    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-8 h-16 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2" style={{ color: "var(--accent-secondary)" }}>
          <span style={{ fontFamily: "var(--font-display)", fontWeight: 600, fontSize: 21 }}>철마제일교회</span>
          <span className="hidden text-[10px] tracking-[0.3em] opacity-90 lg:inline">CHEOLMA JEIL CHURCH</span>
        </Link>
