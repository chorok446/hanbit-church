...
describe("uploadThumbUrl", () => {
  it("업로드 이미지 URL을 .thumb.jpg 로 바꾼다", () => {
    ...
    expect(uploadThumbUrl("https://api.hanbit.com/uploads/a.png")).toBe(
      "https://api.hanbit.com/uploads/a.thumb.jpg",
    );
    expect(uploadThumbUrl("https://api.hanbit.com/uploads/a.webp")).toBe(
      "https://api.hanbit.com/uploads/a.thumb.jpg",
    );
  });
