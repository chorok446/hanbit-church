    ...
    >
      ...
      <Link href={`/posts/${post.id}`} className="block">
        {image ? (
          ...
          <div className="flex aspect-[16/9] items-center justify-center bg-gradient-to-br from-[var(--banner-bg)] to-[var(--banner-bg-soft)] px-6 text-center text-[13px] leading-6 text-white/75">
